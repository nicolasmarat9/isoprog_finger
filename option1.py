...
class Ui_Option1(object):
    ...
    def setupUi(self, Option1):
        ...
        self.MplWidget.setGeometry(QtCore.QRect(255, 71, 721, 691))
        ...
        self.label0.setGeometry(QtCore.QRect(480, 35, 280, 40))
        font = QtGui.QFont()
        ...
        self.pushButton.setGeometry(QtCore.QRect(20, 690, 211, 31))
